...
| `:0.30.5` | Last version |
| `:0.31.1` | Stable version, security and bug fixes only |
| `:0.29.7` | Legacy version, previous stable release |

To use other distributions, these are available: 

| Operating System | Decidim v0.32.0.dev | Decidim v0.30.5 | Decidim v0.31.1 | Decidim v0.29.7 |
| --- | --- | --- | --- | --- |
| Ubuntu noble (24.04) | `:noble-0.32.0.dev` | `:noble-0.30.5` | `:noble-0.31.1` | `:noble-0.29.7` |
| Ubuntu jammy (22.04) | `:jammy-0.32.0.dev` | `:jammy-0.30.5` | `:jammy-0.31.1` | `:jammy-0.29.7` |
| Ubuntu questing (25.10) | `:questing-0.32.0.dev` | `:questing-0.30.5` | `:questing-0.31.1` | `:questing-0.29.7` |
| Redhat ubi9 (9.7) | `:ubi9-0.32.0.dev` | `:ubi9-0.30.5` | `:ubi9-0.31.1` | `:ubi9-0.29.7` |
| Redhat ubi8 (8.10) | `:ubi8-0.32.0.dev` | `:ubi8-0.30.5` | `:ubi8-0.31.1` | `:ubi8-0.29.7` |
...
All the `DECIDIM_` variables are available. [See the documentation on default environments variables](https://github.com/decidim/decidim/blob/v0.31.1/docs/modules/configure/pages/environment_variables.adoc).
