...
All the `DECIDIM_` variables are available. [See the documentation on default environments variables](https://github.com/decidim/decidim/blob/v0.31.4/docs/modules/configure/pages/environment_variables.adoc).
