...
In an empty directory, download the [docker-compose quickstart](https://raw.githubusercontent.com/hfroger/docker/master/docker-compose.0.28.1.yml).

```bash
mkdir my-participatory-platform
cd my-participatory-platform
curl https://raw.githubusercontent.com/hfroger/docker/master/docker-compose.0.28.1.yml > docker-compose.yml
```
