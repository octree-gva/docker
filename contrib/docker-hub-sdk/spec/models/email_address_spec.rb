...
# Unit tests for DockerHubClient::EmailAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DockerHubClient::EmailAddress do
  let(:instance) { DockerHubClient::EmailAddress.new }

  describe 'test an instance of EmailAddress' do
    it 'should create an instance of EmailAddress' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(DockerHubClient::EmailAddress)
    end
  end
