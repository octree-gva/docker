...
# Unit tests for DockerHubClient::AuditLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DockerHubClient::AuditLog do
  let(:instance) { DockerHubClient::AuditLog.new }

  describe 'test an instance of AuditLog' do
    it 'should create an instance of AuditLog' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(DockerHubClient::AuditLog)
    end
  end
