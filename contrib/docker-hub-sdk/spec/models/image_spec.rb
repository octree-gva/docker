...
# Unit tests for DockerHubClient::Image
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DockerHubClient::Image do
  let(:instance) { DockerHubClient::Image.new }

  describe 'test an instance of Image' do
    it 'should create an instance of Image' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(DockerHubClient::Image)
    end
  end
