...
# Unit tests for DockerHubClient::CreateAccessTokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DockerHubClient::CreateAccessTokenRequest do
  let(:instance) { DockerHubClient::CreateAccessTokenRequest.new }
  ...
  describe 'test an instance of CreateAccessTokenRequest' do
    it 'should create an instance of CreateAccessTokenRequest' do
      ...
      # expect(instance).to be_instance_of(DockerHubClient::CreateAccessTokenRequest)
    end
  end
