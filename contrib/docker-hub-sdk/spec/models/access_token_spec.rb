...
# Unit tests for DockerHubClient::AccessToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DockerHubClient::AccessToken do
  let(:instance) { DockerHubClient::AccessToken.new }

  describe 'test an instance of AccessToken' do
    it 'should create an instance of AccessToken' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(DockerHubClient::AccessToken)
    end
  end
