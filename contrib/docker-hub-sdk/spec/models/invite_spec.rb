...
# Unit tests for DockerHubClient::Invite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DockerHubClient::Invite do
  let(:instance) { DockerHubClient::Invite.new }

  describe 'test an instance of Invite' do
    it 'should create an instance of Invite' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(DockerHubClient::Invite)
    end
  end
